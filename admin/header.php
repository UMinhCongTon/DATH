...
<div class="header">
  <div class="shimmer">
  <b style="font-size: 30px; line-height: 30px;"><span class="material-icons">sailing</span>&ensp;OLD THINGS BOAT</b>
  </div>
</div>
...
<nav class="navi">
  <ul style="margin-top: 0%; padding: 0; list-style-type: none;">
    ...
    <li id="books" onclick="location.replace('view_books.php')"><span class="material-icons md-40 md-light">sailing</span></li>
