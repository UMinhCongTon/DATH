...
<?php 
    ...
    if(!isset($_SESSION["CUS_ID"]))
    {
        ...
        {
            echo "<p style='color: red; background-color: white; font-size: large; width: 150px'>No productions found  :(</p>";
        }
...
<script>
    ...
    consoleText2(['Available products...', 'Available products...', 'Available products...'], 'text',['rgb(255, 0, 102)','rgb(92, 214, 92)','rgb(191, 128, 255)']);
