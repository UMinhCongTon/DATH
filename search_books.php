...
<div style="margin-right:10%">
    ...
    <select name="searchby">
          ...
          <option value="book.author">Saler</option>
...
?>
    ...
    <script>
        consoleText(['Product Purchased...', 'Product Purchased...', 'Product Purchased...'], 'text',['rgb(255, 0, 102)','rgb(92, 214, 92)','rgb(191, 128, 255)']);
